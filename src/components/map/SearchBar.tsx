...
const SearchBar = ({ isRoutingMode, selectingPoint, onSelectResult }: SearchBarProps) => {
  ...
  return (
    <div className="absolute top-3 sm:top-4 left-1/2 -translate-x-1/2 z-30 w-full max-w-sm sm:max-w-md px-3 sm:px-4">
      <div className="relative">
        <div className="relative flex items-center">
          ...
          <input
            ...
            className="w-full pl-12 pr-12 py-3.5 bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-gray-200 text-base focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary placeholder:text-gray-400 touch-manipulation"
          />
          {isSearching && (
          ...
          {!isSearching && searchQuery && (
            <button
              ...
              className="absolute right-4 p-1 hover:bg-gray-100 rounded touch-manipulation min-h-[44px] min-w-[44px] flex items-center justify-center"
            >
          ...
          {showSearchResults && !isSearching && searchResults.length > 0 && (
            ...
            >
              <div className="sticky top-0 z-10 flex items-center justify-between px-4 py-3 bg-white/95 backdrop-blur-sm border-b border-gray-100">
                <span className="text-sm font-medium text-gray-600">{searchResults.length} results</span>
                <button
                  onClick={() => {
                    setShowSearchResults(false);
                    setSearchQuery("");
              ...
              {searchResults.map((result) => {
                ...
                return (
                  <button
                    ...
                    className="w-full flex items-start gap-3 p-4 hover:bg-gray-50 transition-colors text-left border-b border-gray-100 last:border-b-0 touch-manipulation min-h-[72px]"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="text-sm text-primary/70 mt-1 capitalize">
        ...
        <AnimatePresence>
          {showSearchResults && searchQuery.length >= 2 && searchResults.length === 0 && !isSearching && (
            ...
            >
              <div className="flex items-center justify-between px-4 py-3 border-b border-gray-100">
                <span className="text-sm font-medium text-gray-600">No results</span>
                <button
                  onClick={() => {
                    setShowSearchResults(false);
                    setSearchQuery("");
              ...
              <div className="p-6 text-center">
                ...
                <p className="text-base text-gray-500">No places found for "{searchQuery}"</p>
